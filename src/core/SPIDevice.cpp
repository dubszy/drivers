...
SPIDevice::SPIDevice(int channel, int speed, uint8_t bitsPerWord) {
...
int SPIDevice::transact(uint8_t *data, int length) {
    return transact_((void *)data, length);
}

int SPIDevice::transact16(uint16_t *data, int length) {
    return transact_((void *)data, length);
}

int SPIDevice::transact32(uint32_t *data, int length) {
    return transact_((void *)data, length);
}

int SPIDevice::transact64(uint64_t *data, int length) {
    return transact_((void *)data, length);
}

int SPIDevice::transact_(void *data, int length) {
